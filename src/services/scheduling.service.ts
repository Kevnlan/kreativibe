...
export const schedulingService = {
  ...
  async publishNow(campaignId: string, postId: string): Promise<ScheduledPost> {
    return apiClient.post(`/campaigns/${campaignId}/schedule/${postId}/publish-now`, {});
  },
};
